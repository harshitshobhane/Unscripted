    ...
    <div className={styles.container}>
      <div className={styles.info}>
        ...
        <div className={styles.icons}>
          ...
          <Link href="https://github.com/harshitshobhane" target="_blank" rel="noopener noreferrer">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 0C5.37 0 0 5.37 0 12c0 5.3 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.09-.745.083-.729.083-.729 1.205.085 1.84 1.237 1.84 1.237 1.07 1.834 2.807 1.304 3.492.997.108-.775.418-1.305.762-1.605-2.665-.304-5.466-1.332-5.466-5.931 0-1.31.469-2.381 1.236-3.221-.124-.303-.535-1.523.117-3.176 0 0 1.008-.322 3.301 1.23a11.52 11.52 0 0 1 3.003-.404c1.018.005 2.045.138 3.003.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.873.119 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.803 5.625-5.475 5.921.43.372.823 1.102.823 2.222v3.293c0 .322.218.694.825.576C20.565 21.796 24 17.297 24 12c0-6.63-5.373-12-12-12z" fill="#181717"/>
            </svg>
          </Link>
      ...
      <div className={styles.links}>
        ...
        <div className={styles.list}>
          ...
          <Link href="https://www.linkedin.com/in/harshitshobhane" target="_blank" rel="noopener noreferrer">LinkedIn</Link>
          <Link href="https://github.com/harshitshobhane" target="_blank" rel="noopener noreferrer">GitHub</Link>
          <Link href="/">Instagram</Link>
          <Link href="https://twitter.com/harshitshobhane" target="_blank" rel="noopener noreferrer">Twitter</Link>
        </div>
      </div>
    </div>
  );
